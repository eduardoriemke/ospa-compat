...
async function ospaOpenEditor(id, papel) {
  ...
  try {
    ...
    // Só disciplinas cadastradas (a tela de Configurações mantém esta lista).
    // Pastas do Drive sem disciplina não viram opção nas fichas.
    const disciplinas = (cfg.disciplinas || []).slice();
